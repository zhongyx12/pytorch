...
Tensor arange(
  ...
  Tensor result = at::_empty({0}, dtype, layout, device, pin_memory);  // to be filled by arange_out
...
Tensor empty_cpu(IntArrayRef size, c10::optional<c10::ScalarType> dtype, c10::optional<c10::Layout> layout, c10::optional<c10::Device> device, c10::optional<bool> pin_memory, c10::optional<c10::MemoryFormat> optional_memory_format) {
  ...
  auto storage_impl = c10::make_intrusive<StorageImpl>(
    ...
    nelements,
    allocator->allocate(nelements * scalarTypeToTypeMeta(dtype.value()).itemsize()), // [CHECK THIS] allocator->allocate(nelements * dtype.itemsize()),
    allocator,
    /*resizeable=*/true);
...
Tensor new_empty(
  ...
  return at::_empty(size, dtype, layout, device, pin_memory); // [CHECK THIS] BUG. see changes
}
